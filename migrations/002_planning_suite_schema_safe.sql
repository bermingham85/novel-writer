-- Novel Planning Suite - Database Schema Migration (SAFE VERSION)
-- Version: 002-safe
-- Date: 2025-12-24
...
-- NOTE: This version drops existing indexes before recreating to avoid conflicts

-- ============================================================================
-- DROP EXISTING INDEXES (safe to run if they don't exist)
-- ============================================================================
...
DROP INDEX IF EXISTS idx_worlds_series;
DROP INDEX IF EXISTS idx_locations_world;
DROP INDEX IF EXISTS idx_locations_parent;
DROP INDEX IF EXISTS idx_story_arcs_series;
DROP INDEX IF EXISTS idx_story_arcs_book;
DROP INDEX IF EXISTS idx_story_arcs_type;
DROP INDEX IF EXISTS idx_scene_outlines_book;
DROP INDEX IF EXISTS idx_scene_outlines_chapter;
DROP INDEX IF EXISTS idx_songs_series;
DROP INDEX IF EXISTS idx_songs_book;
DROP INDEX IF EXISTS idx_songs_chapter;
DROP INDEX IF EXISTS idx_songs_suno_id;
DROP INDEX IF EXISTS idx_planning_conversations_series;
DROP INDEX IF EXISTS idx_planning_conversations_book;
DROP INDEX IF EXISTS idx_planning_conversations_topic;
DROP INDEX IF EXISTS idx_planning_conversations_created;
DROP INDEX IF EXISTS idx_ideas_series;
DROP INDEX IF EXISTS idx_ideas_book;
DROP INDEX IF EXISTS idx_ideas_type;
DROP INDEX IF EXISTS idx_ideas_status;
DROP INDEX IF EXISTS idx_copyright_checks_series;
DROP INDEX IF EXISTS idx_copyright_checks_type;
DROP INDEX IF EXISTS idx_copyright_checks_status;
DROP INDEX IF EXISTS idx_copyright_checks_content;
DROP INDEX IF EXISTS idx_quality_checks_series;
DROP INDEX IF EXISTS idx_quality_checks_type;
DROP INDEX IF EXISTS idx_quality_checks_check_type;
DROP INDEX IF EXISTS idx_quality_checks_content;
